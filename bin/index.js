...
var Beandocs = function()
{
    ...
    this.getDocs = function(opsOrInput, callback)
    {
        var ops = {};
        ...
        finder.on('file', function(file)
        {
            ...
            self.parseFile(file).forEach(function(docs)
            {
    ...
    this.generate = function(opsOrInput, output)
    {
        ...
        self.getDocs(opsOrInput, function(docs)
        {
            writer.end(docs);
        });
    }
